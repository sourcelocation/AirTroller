...
struct ContentView: View {
    ...
    @StateObject var trollController = TrollController(sharedURL: Bundle.main.url(forResource: "fr", withExtension: "png")!, rechargeDuration: 0.5, logger: { str in remLog(str) })
